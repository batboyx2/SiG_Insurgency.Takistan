...
//if (isClass(configFile>>"CfgPatches">>"acre_main")) then {
	...
	_box addItemCargoGlobal ["ACRE_PRC117F", 50];
	_box addItemCargoGlobal ["ACRE_PRC148", 50];
	_box addItemCargoGlobal ["ACRE_PRC152", 50];
	_box addItemCargoGlobal ["ACRE_PRC343", 100];
	_box addItemCargoGlobal ["ACRE_PRC77", 50];
//};
...
//	_pos = randPos;
// }; 
_pos = [(getPos hqSpawn select 0), (getPos hqSpawn select 1), -0.2];
_dir = getDir hqSpawn;
