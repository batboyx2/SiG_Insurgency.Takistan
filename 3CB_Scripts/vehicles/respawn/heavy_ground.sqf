...
_unitinit = "_eh = this addEventHandler [""GetIn"", {_this execVM ""3cb_scripts\vehicles\lock_crewman.sqf""}]";
_haveinit = if (count _this > 6) then {true} else {false};
*/

// Define variables (custom)
_unit = _this;
_delay = 240;
_deserted = 3600;
_respawns = 0;
...
{	
	...
	{	
		...
		//Explosion Sizes:
						...
						//Large			"M_Sidewinder_AA"
						//Huge			"Bo_GBU12_LGB"
						//Other			"M_TOW_AT", "HelicopterExploBig"
