// by Xeno - Edited by Phantom of PhanTactical
...
if (isNil "x_reload_time_factor") then {x_reload_time_factor = 4;};
...
sleep x_reload_time_factor;
if (!alive _object) exitWith {};
_object vehicleChat format ["Vehicle has been successfully serviced.", _type_name];
